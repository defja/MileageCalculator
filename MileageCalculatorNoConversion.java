...
public class MileageCalculatorNoConversion extends Application {
	...
	private void changeLabels() {
		...
		if (cbo.getItems().indexOf(cbo.getValue()) != 0 && lblCapacity.getText().equals(defaultCapacity)) {
			// update labels
	...
	private void calcMileage() {
		...
		double result = 0.0;
		if (cbo.getItems().indexOf(cbo.getValue()) != 0) {
			// liters / 100KM
